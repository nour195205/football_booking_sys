    ...
    <div class="container py-5">
        ...
        <div class="row mb-5 justify-content-center">
            @foreach($fields as $field)
                <div class="col-md-6 mb-4">
                    <div class="card h-100 field-card shadow-sm"
                        onclick="showSchedule({{ $field->id }}, '{{ $field->name }}')">
        ...
        <div id="schedule-section" class="d-none bg-white p-5 rounded-4 shadow border-0">
            <div class="d-flex justify-content-between align-items-center mb-5">
                ...
                <input type="date" id="search-date" class="form-control form-control-lg w-auto shadow-sm"
                    value="{{ date('Y-m-d') }}" onchange="refreshSlots()">
            </div>
            <div id="slots-view">
            </div>
        </div>
